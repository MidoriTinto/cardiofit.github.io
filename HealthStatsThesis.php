...
<html lang="en">
  <head>
    <title>CardioFit - My Health Stats</title>
    <meta charset="utf-8">
          ...
          <div class="row" style="background-color: #EEFAFB;">                              
                <ul class="pager"><!--set up pager buttons-->
                  <div class="col-xs-6 col-md-6">
                      <h2 class="pull-left"> My Health Stats </h2>
                  </div>
                  <div class="col-xs-6 col-md-6">
...
<div class="container-fluid">
   <div class="row">
    <div class="table-responsive">
     ...
     <?php
      ...
      $sql = "SELECT healthID, date_taken, weight, BMI, blood_pressure, blood_glucose, waist FROM healthstats WHERE id=$id";
      $result = mysqli_query($conn, $sql);

      if ($result-> num_rows > 0) {
          // output data of each row
      echo"<table><tr><th>ID</th><th>date</th><th>weight [kg] </th><th>BMI</th><th>BG</th><th>BP [mg/dL]</th><th>Waist [cm]</th></th>";

      while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td>" . $row["healthID"]. " </td><td>" . $row["date_taken"]. " " . " </td><td>" . $row["weight"]. " " . " </td><td> " . $row["BMI"]. " " .  " </td><td>" . $row["blood_pressure"]. " " ." </td><td>" . $row["blood_glucose"]. " " ." </td><td>" . $row["waist"]. " " ."</td></tr>";
        } echo"</table>";
        } else {
          echo "0 results";
        }
  ...
  <ul class="pager"><!--set up pager buttons-->
                                        <li class="previous"><a href="OptionThesis2.html"><span class="glyphicon glyphicon-home"></span>Home</a></li>
                                        <li class="next"><a href="HealthStatsThesis.html"><span class="glyphicon glyphicon-plus"></span>Add New</a></li>
                      </ul><!--Add will be going to the next page - will take me to EnterNEW-->
              </div>
          </div>
        </div>
