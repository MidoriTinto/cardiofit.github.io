  ...
  padding:2px;
    ...
    <body>
      <!--<header class="container-fluid">
        <div class="row" style="background-color:#eee"><h3>CardioTool</h3></div>
      </header>-->
   ...
   <div class="row">
    <div class="table-responsive">
     ...
     <?php
      ...
      echo"<table><tr><th>MedID</th><th>Name</th><th>Dosage</th><th>Units</th><th>Times</th><th>Notes</th></tr>";

      while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td>" . $row["medsID"]. " </td><td>" . $row["name"]. " " . " </td><td>" . $row["dosage"]. " " . " </td><td> " . $row["units"]. " " .  " </td><td>" . $row["time"]. " " . "</td><td>" . $row["notes"]. " " ."</td></tr>";
        } echo"</table>";
        } else {
          echo "0 results";
        }
      ...
      ?> 
                      ...
                      <ul class="pager"><!--set up pager buttons-->
                                        <li class="previous"><a href="OptionsThesis1.html"><span class="glyphicon glyphicon-chevron-left"></span>Previous</a></li>
